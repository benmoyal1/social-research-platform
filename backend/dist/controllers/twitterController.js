...
export async function getPaginatedPosts(req, res) {
    try {
        ...
        const result = await twitterService.getPaginatedTwitterPosts(parseInt(page), parseInt(limit), filters);
        res.json(result);
    }
    catch (error) {
 ...
 */
export async function exportAllPosts(_req, res) {
    try {
 ...
 */
export async function exportFilteredPosts(req, res) {
    try {
